    ...
    <div class="card-body">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class = "btn btn-danger" id="delete" href="deleteUser.php?del=<?php echo $row['id'] ?>">
                    ...
                    <div class="form-group row">
                           ...
                           <div class="">
                               <?php 
                               if($row['status'] == 1){ ?>
                                    <a href="status.php?id=<?php echo $row['id'] ?>&status=0"><button class="btn btn-success" id="block">Unblock</button></a>
                               <?php }else{ ?>
                                    <a href="status.php?id=<?php echo $row['id'] ?>&status=1"><button class="btn btn-danger" id="block">Block</button></a>
                               <?php }
                               ?>
                           </div>
                        </div>
